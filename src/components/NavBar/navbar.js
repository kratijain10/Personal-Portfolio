        ...
        <button className='desktopMenuBtn' onClick={()=>{
          document.getElementById('contact').scrollIntoView({behavior: 'smooth'});
           ...
           <div className='navMenu' style={{display : showMenu?'flex':'none'}}>
            ...
            <Link activeClass='active' to='projectSection' spy={true} smooth={true} offset={-50} duration={500} className='ListsItems' onClick={()=>setShowMenu(!showMenu)}>Projects & Skills</Link>
